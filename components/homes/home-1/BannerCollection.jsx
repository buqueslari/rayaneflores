      ...
      <div className="container">
        <div className="tf-grid-layout md-col-2">
          <div className="collection-default hover-img">
            <a className="img-style" href={`/shop/presente`}>
          ...
          <div className="collection-position hover-img">
            <a className="img-style" href={`/shop/arranjo`}>
            ...
            <div className="content">
              <h3 className="title">
                <Link href={`/shop/arranjo`} className="link text-white wow fadeInUp">
                  Arranjos
                </Link>
              </h3>
              <p className="desc text-white wow fadeInUp">Reservado para ocasiões especiais</p>
              <div className="wow fadeInUp">
                <Link href={`/shop/arranjo`} className="btn-line style-white">
                  Compre Agora
                </Link>
              </div>
            </div>
