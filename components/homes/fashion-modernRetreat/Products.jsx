        ...
        <div className="tf-grid-layout md-col-2">
          ...
          <div className="banner-discover-right">
            <div className="banner-cls-discover hover-img">
              <Link href={`/shop/presente`} className="img-style" style={{ position: "relative", objectFit: "contain" }}>
              ...
              <div className="cls-content">
                <div className="box-title-top wow fadeInUp">
                  {/* <h3 className="title">
                    <Link href={`/shop/presente`} className="link text-white">
                      Shop our top picks
                    </Link>
                  </h3>
                ...
                <div className="wow fadeInUp">
                  <Link href={`/shop/presente`} className="tf-btn btn-fill btn-white">
